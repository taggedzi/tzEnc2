...
from tzEnc2.main import encrypt, decrypt, CHARACTER_SET

# --------------- Constants ---------------

# Generate a 1000-character “plain text”
def generate_plain_text(length: int) -> str:
...
Phasellus ut sagittis massa. Aliquam porta congue ipsum, vel laoreet tortor tempor et. Nulla sodales odio sapien, et tristique libero cursus vehicula. Cras vitae dictum felis. In consectetur""" * 100
